...
Before starting the execution, user should ensure that he has all the files mentioned in code files section such as "final.c", "lcd.h" and "matlabwb.m".
...
LINK FOR VIDEO:
====================
FOllowing is the link for the video of the project:
http://www.youtube.com/watch?v=bsQQnirghbw&feature=plcp